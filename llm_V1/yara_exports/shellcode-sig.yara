rule document_API_hashing_shellcode_1776 
 {
	meta:
		sigid = 1776
		date = "2016-02-01 08:00 AM"
		threatname = "document_API_hashing_shellcode"
...
rule shellcodeReverseTcp_1775 
 {
	meta:
		sigid = 1775
		date = "2016-02-01 08:00 AM"
		threatname = "shellcodeReverseTcp"
		category = "Malware & Botnet"
		risk = 50
...
rule shellcodeBindTcp_1773 
 {
	meta:
		sigid = 1773
		date = "2016-02-01 08:00 AM"
		threatname = "shellcodeBindTcp"
		category = "Malware & Botnet"
		risk = 30
...
rule shellcodeFindKernel32_1772 
 {
	meta:
		sigid = 1772
		date = "2016-02-01 08:00 AM"
		threatname = "shellcodeFindKernel32"
		category = "Malware & Botnet"
		risk = 30
...
rule find_kernel32_base_method_shellcode_1783 
 {
	meta:
		sigid = 1783
		date = "2016-02-01 08:00 AM"
		threatname = "find_kernel32_base_method_shellcode"
		category = "Malware & Botnet"
		risk = 30
...
rule find_kernel32_base_method_shellcode_1784 
 {
	meta:
		sigid = 1784
		date = "2016-02-01 08:00 AM"
...
rule shellcodeBindTcpXpfw_1774 
 {
	meta:
		sigid = 1774
		date = "2016-02-01 08:00 AM"
		threatname = "shellcodeBindTcpXpfw"
		category = "Malware & Botnet"
		risk = 30
...
rule getEIP_method_shellcode_1786 
 {
	meta:
		sigid = 1786
		date = "2016-02-01 08:00 AM"
		threatname = "getEIP_method_shellcode"
		category = "Malware & Botnet"
		risk = 30
...
rule generic_shellcode_patterns_1788 
 {
	meta:
		sigid = 1788
		date = "2016-02-01 08:00 AM"
		threatname = "generic_shellcode_patterns"
		category = "Malware & Botnet"
		risk = 30
		
	strings:
		$a0 = { 41 41 41 80 30 28 1b e8 4c a3 76 14 5c 07 5f 28 28 }
